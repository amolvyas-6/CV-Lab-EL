...
DEFAULT_DOWNLOAD_SCENE: Final[bool] = True
DEFAULT_ANNOTATE_SHIPS: Final[bool] = True
DEFAULT_SHIP_MIN_AREA_PX: Final[int] = 2
DEFAULT_SHIP_MAX_AREA_PX: Final[int] = 600
DEFAULT_SHIP_MIN_INTENSITY: Final[int] = 130
DEFAULT_SHIP_THRESHOLD_PERCENTILE: Final[float] = 99.5
